    ...
    return (
        <div className="flex justify-between mt-6">
            ...
            <div className=" ml-[8rem] border-r-2 border-gray-400 p-6">
                <h1 className="font-bold font-oswald text-5xl text-gray-700 text-center">Lives Saved</h1>
            ...
            <div className="ml-[2rem] p-3">
                <h1 className="font-bold font-oswald text-4xl text-gray-700 text-center">Avg Time to adopt</h1>
                <p className='font-bold text-4xl text-center mt-3'>45 Days</p>


                <p className='font-semibold text-gray-500 text-center text-xl mt-6 mb-2'>Avg Time to Adapt by Age bucket</p>
                <Sidebar1 />
            ...
            <div className=" mr-[8rem] p-3  ml-[3rem]">
                <h1 className="font-bold font-oswald text-4xl text-gray-700 text-center ">Characteristics</h1>

                <p className='font-semibold  text-gray-500 text-left text-xl mt-6'>Proportions of Dogs that ...</p>

                <Multibar />
               
                <p className='font-semibold text-gray-500 text-left text-xl mt-6'>Top 10 Primary Breeds(Including Mixes)</p>
                <Sidebar2 />
            </div>
